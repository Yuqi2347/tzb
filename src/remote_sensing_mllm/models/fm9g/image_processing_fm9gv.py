...
class FM9GVBatchFeature(BatchFeature):
    r"""
    ...
    def to(self, *args, **kwargs) -> "FM9GVBatchFeature":
...
class FM9GVImageProcessor(BaseImageProcessor):
    ...
    def get_sliced_images(self, image, max_slice_nums=None):
        ...
        source_image, patches, sliced_grid = self.slice_image(
            ...
            never_split=False              #设置是否切片为单patch
        )
    ...
    def preprocess(
            ...
            do_pad: Optional[bool] = True, # TODO: add pad for FM9G-Llama3-V-2_5
